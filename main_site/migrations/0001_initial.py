    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_img', models.ImageField(blank=True, null=True, upload_to='companies_uploads', verbose_name='Главное изображение')),
                ('is_published', models.BooleanField(default=True, help_text='Отображение данных на странице сайта.', verbose_name='Отображение')),
                ('priority', models.DecimalField(decimal_places=0, help_text='Определяет очередность отображения информации на странице сайта (1 - 99).', max_digits=2, null=True, verbose_name='Приоритет отображения')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_img', models.ImageField(blank=True, null=True, upload_to='categories_uploads', verbose_name='Главное изображение')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('full_description_ru', models.TextField(max_length=1500, null=True, verbose_name='Полное описание')),
                ('full_description_en', models.TextField(max_length=1500, null=True, verbose_name='Полное описание')),
                ('head_img', models.ImageField(blank=True, null=True, upload_to='classes_uploads', verbose_name='Главное изображение')),
                ('is_published', models.BooleanField(default=True, help_text='Отображение данных на странице сайта.', verbose_name='Отображение')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_site.company', verbose_name='Комания')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('head_img', models.ImageField(blank=True, null=True, upload_to='news_uploads', verbose_name='Главное изображение')),
                ...
                ('slug', models.SlugField(max_length=150, unique=True, verbose_name='URL')),
                ('body1', ckeditor.fields.RichTextField(blank=True, help_text='Тескт статьи до карусели дополнительных изображений', verbose_name='Содержание статьи')),
                ...
                ('additional_imgs', models.ImageField(blank=True, null=True, upload_to='news_uploads', verbose_name='Дополнительные зображения')),
                ('body2', ckeditor.fields.RichTextField(blank=True, help_text='Тескт статьи после карусели дополнительных изображений', verbose_name='Содержание статьи')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('head_img', models.ImageField(blank=True, null=True, upload_to='objects_uploads', verbose_name='Главное изображение')),
                ('is_published', models.BooleanField(default=True, help_text='Отображение данных на странице сайта.', verbose_name='Отображение')),
                ('company', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='main_site.company', verbose_name='Комания')),
