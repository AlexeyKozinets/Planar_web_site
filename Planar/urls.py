...
urlpatterns += [path('ckeditor/', include('ckeditor_uploader.urls')),] #CKeditor
                                                                    ...
                                                                    # multiLang:24) cmd manage.py makemessages -l en -i env (dir\locale\..\django.po)
                                                                    # (next: *project_name*/urls.py)

                                                                    # multiLang:25) cmd manage.py compilemessages (dir\locale\..\django.mo)
                                                                    # (next: *project_name*/urls.py)

                                                                    # multiLang:26) for new models or new fields need te repeat
                                                                    # steps: 7 - 17 (end)